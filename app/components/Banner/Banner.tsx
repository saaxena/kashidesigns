                ...
                <div className="mx-auto max-w-7xl pt-16 sm:pt-20 pb-20 banner-image">
                    <div className="text-center">
                        ...
                        <p className="mt-6 text-lg leading-8 text-bluegray">
                            Kashi Patient design  is the leading platform in Autocad design and services our expert patent illustration team is here to <br/> provide you with the highest quality illustrations to support your patent application
                        </p>
                    </div>
