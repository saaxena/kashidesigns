                ...
                <div className="lg:relative">
                    ...
                    <span className="lg:absolute lg:bottom-40 lg:left-80">
                        ...
                        <div className="lg:inline-block bg-white rounded-2xl p-5 shadow-sm">
                            <p className="text-base font-normal text-center text-darkgray">Build your autocad design within a transparent <br /> community. Follow other investors, share people from <br /> different professional design, and never be alone.</p>
