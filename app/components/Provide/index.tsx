...
const Aboutdata: datatype[] = [
    {
        ...
        country: "Patent Drawings",
        paragraph: 'We produce high quality, professional patent illustrations',

    },
    {
        imgSrc: "/assets/provide/graphic.svg",
        country: "Trial Graphics",
        paragraph: 'Allow us to assist in any graphical support needs you may have',

    },
    {
        imgSrc: "/assets/provide/heaking.svg",
        country: "3D Modeling",
        paragraph: 'We build professionally crafted 3D models and rendering',

    },
    {
        imgSrc: "/assets/provide/uidesign.svg",
        country: "Patent Drafting & Filing",
        paragraph: 'Inventors, we can help you through the patent filing process',
    }
]
